...
```{r plothorse, out.width="110%", fig.cap = "Horse populations for all provinces in Canada from 1906 - 1972", echo = FALSE}
...
```{r plotlargest, out.width="60%",fig.cap = "Horse populations for the province with the largest standard deviation", echo = FALSE}
